...
import { StyleSheet, Text, View, ImageBackground, TouchableOpacity, ImageBackgroundComponent, FlatList } from 'react-native'
            ...
            <View style={{ marginTop: 5, paddingBottom: 20 }}>
                <FlatList
                    ...
                    renderItem={({ item, index }) => (
                        <ProductCard image={item.image} price={item.price} productName={item.name} />
                    )}
